...
import { getUser } from "../Store/ActionCreater/UserActionCreater"
import { deleteWishlist, getWishlist } from "../Store/ActionCreater/WishlistActionCreater"
import { getCheckout } from "../Store/ActionCreater/CheckoutActionCreater"
...
export default function Profile() {
    ...
    return (
        <div className='ftco-section ftco-cart container'>
            <div className="row">
                <div className="col-md-6">
                    {
                        user.pic ?
                            <img src={`/assets/productimages/${user.pic}`} height="520px" width="100%" alt="" /> :
                            <img src={`/assets/productimages/p100.jpg`} height="520px" width="100%" alt="" />
                    }
                </div>
                <div className="col-md-6">
