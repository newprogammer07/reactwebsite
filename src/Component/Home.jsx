...
import { getProduct } from "../Store/ActionCreater/ProductActionCreater"
...
export default function Home() {
	...
	return (
		<>
			<section id="home-section" className="hero myslider bg-info">
								...
								<div className="col-md-12">
									<div className="row no-gutters">
										<div className="col-md-6">
											<div className="choose-wrap wrap img align-self-stretch bg-light d-flex align-items-center"  style={{ backgroundImage: "url('assets/productimages/p67.jpg')" }}>
										...
										<div className="col-md-6">
											<div className="choose-wrap wrap img align-self-stretch d-flex align-items-center"  style={{ backgroundImage: "url('assets/productimages/p67.jpg')" }}>
